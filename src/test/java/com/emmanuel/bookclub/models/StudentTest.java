...
public class StudentTest {
    ...
    private Student student2 = new Student("SU17201", "Shaibu", currentRegDate.plusHours(2),
            "Cohort 22", "Android");
    private Student student3 = new Student("SU17201", "Shaibu", "kogi@yahoo.com", "Kogi",
            currentRegDate.plusHours(2), Gender.MALE, "Cohort 22", "Android");
    ...
    public void testGetLevel() throws Exception {
        ...
        assertEquals("Cohort 22", student3.getLevel());
    }
